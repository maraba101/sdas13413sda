...
if(!user) return message.channel.send(
    ...
    .setColor('BLACK')
    .setAuthor(`${client.user.username} Kayıt Sistemi`, client.user.displayAvatarURL({dynamic: true}))
    .setDescription(`Kimi kayıt edeceğimi belirtmelisin. .erkek @Electus Electus 20`)
    .setFooter(`${message.author.tag} istedi.`, message.author.displayAvatarURL({dynamic: true}))
    )
var isim = args[1]
if(!yaş) return message.channel.send(
    ...
    .setColor('BLACK')
    .setAuthor(`${client.user.username} Kayıt Sistemi`, client.user.displayAvatarURL({dynamic: true}))
    .setDescription(`Bir yaş belirtin! Örnek Kullanım : .erkek @Electus Electus 20`)
    .setFooter(`${message.author.tag} istedi.`, message.author.displayAvatarURL({dynamic: true}))
    )
if(isNaN(yaş)) return message.channel.send(
    ...
    .setColor('BLACK')
    .setAuthor(`${client.user.username} Kayıt Sistemi`, client.user.displayAvatarURL({dynamic: true}))
    .setDescription(`Yaş'da harf bulunamaz. .erkek @Electus Electus 20`)
    .setFooter(`${message.author.tag} istedi.`, message.author.displayAvatarURL({dynamic: true}))
    )
if(!isim) return message.channel.send(
    ...
    .setColor('BLACK')
    .setAuthor(`${client.user.username} Kayıt Sistemi`, client.user.displayAvatarURL({dynamic: true}))
    .setDescription(`Bir isim belirtin! .erkek @Electus Electus 20`)
    .setFooter(`${message.author.tag} istedi.`, message.author.displayAvatarURL({dynamic: true}))
    )
